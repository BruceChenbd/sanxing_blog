...
export default {
    ...
    devServer: {
        ...
        proxy: {
            '/api/v2': {
                target: 'http://192.168.3.185:18080',
                // target: 'http://192.168.3.197:18080',
                // target: 'http://192.168.3.18:18080',
                changeOrigin: true,
                secure: false
            },
            '/api/v': {
                target: 'http://192.168.3.18:8092',
                changeOrigin: true,
                secure: false
            },
            '/api': {
                    ...
                    },
                    {
                        ...
                        options: {
                            resources: [
                                ...
                                path.resolve(__dirname, './src/work/style/global.scss')
                            ]
                        }
                    }
                ]
